...
| `PrimeFactorUnimodality.Mathlib.Analysis.Fourier.ExponentialAliasing` | `Mathlib/Analysis/Fourier/ExponentialAliasing.lean` | project-verified | Summability and exact geometric bounds for lattice periodization under finite exponential envelopes |
