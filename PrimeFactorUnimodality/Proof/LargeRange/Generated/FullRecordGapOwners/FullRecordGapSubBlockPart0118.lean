...
theorem fullRecordGapSubBlock_part0118 (d : Nat) (59905 ≤ d) (d ≤ 60416) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 60161 ≤ d
  ·
    by_cases h : 60289 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 94613) (by norm_num)
      right
      exact ⟨60000, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
