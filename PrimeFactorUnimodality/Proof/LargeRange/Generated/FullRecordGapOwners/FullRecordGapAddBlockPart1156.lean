...
theorem fullRecordGapAddBlock_part1156 (d : Nat) (135169 ≤ d) (d ≤ 135680) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨73383, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨334641, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨32758025, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨108092, by norm_num, by norm_num, by norm_num⟩
                  ·
