...
theorem fullRecordGapSubBlock_part0167 (d : Nat) (84993 ≤ d) (d ≤ 85504) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 85249 ≤ d
  ·
    by_cases h : 85377 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 42701) (by norm_num)
      exact by decide
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 42677) (by norm_num)
      exact by decide
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 228523) (by norm_num)
      right
      exact ⟨85050, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
