...
theorem fullRecordGapSubBlock_part0156 (d : Nat) (79361 ≤ d) (d ≤ 79872) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 79617 ≤ d
  ·
    by_cases h : 79745 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 752627) (by norm_num)
      right
      exact ⟨79860, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 39857) (by norm_num)
      exact by decide
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 39761) (by norm_num)
      exact by decide
                  ·
