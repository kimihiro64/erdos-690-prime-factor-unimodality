...
theorem fullRecordGapSubBlock_part0150 (d : Nat) (76289 ≤ d) (d ≤ 76800) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 76545 ≤ d
  ·
    by_cases h : 76673 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03599_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 38177) (by norm_num)
      exact by decide
                  ·
