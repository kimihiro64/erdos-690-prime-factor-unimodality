...
theorem fullRecordGapSubBlock_part0155 (d : Nat) (78849 ≤ d) (d ≤ 79360) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 79105 ≤ d
  ·
    by_cases h : 79233 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 47779) (by norm_num)
      right
      exact ⟨31421, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 39551) (by norm_num)
      exact by decide
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 39509) (by norm_num)
      exact by decide
                  ·
