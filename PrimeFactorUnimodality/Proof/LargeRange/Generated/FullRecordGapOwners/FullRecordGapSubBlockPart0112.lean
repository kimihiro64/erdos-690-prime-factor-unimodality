...
theorem fullRecordGapSubBlock_part0112 (d : Nat) (56833 ≤ d) (d ≤ 57344) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 57089 ≤ d
  ·
    by_cases h : 57217 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 53890553) (by norm_num)
      right
      exact ⟨57024, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
