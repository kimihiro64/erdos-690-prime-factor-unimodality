...
theorem fullRecordGapSubBlock_part0380 (d : Nat) (194049 ≤ d) (d ≤ 194560) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨92015, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨194302, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨194284, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨194164, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨194092, by norm_num, by norm_num, by norm_num⟩
                  ·
