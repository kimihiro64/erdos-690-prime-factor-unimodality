...
theorem fullRecordGapAddBlock_part1390 (d : Nat) (254977 ≤ d) (d ≤ 255488) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨5703321, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨61945593, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨77388, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨1608180921, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨4695675, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨27896, by norm_num, by norm_num, by norm_num⟩
                  ·
