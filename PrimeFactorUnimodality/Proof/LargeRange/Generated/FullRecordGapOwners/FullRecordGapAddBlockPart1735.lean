...
theorem fullRecordGapAddBlock_part1735 (d : Nat) (431617 ≤ d) (d ≤ 432128) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨763265, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3250721, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨9093, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3655955727, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨592463, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨6612, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨249463, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨54581, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨329175, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3308559, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨19779113, by norm_num, by norm_num, by norm_num⟩
                  ·
