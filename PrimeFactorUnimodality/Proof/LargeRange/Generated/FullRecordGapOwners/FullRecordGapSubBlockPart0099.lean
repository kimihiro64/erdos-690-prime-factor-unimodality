...
theorem fullRecordGapSubBlock_part0099 (d : Nat) (50177 ≤ d) (d ≤ 50688) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 50433 ≤ d
  ·
    by_cases h : 50561 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 92419) (by norm_num)
      right
      exact ⟨50400, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
