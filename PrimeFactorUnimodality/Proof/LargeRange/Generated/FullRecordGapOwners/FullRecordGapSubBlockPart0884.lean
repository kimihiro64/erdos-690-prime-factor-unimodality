...
theorem fullRecordGapSubBlock_part0884 (d : Nat) (452097 ≤ d) (d ≤ 452608) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨452590, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨452524, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨452482, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨452470, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨452338, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨107151, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨452202, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨452164, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨452118, by norm_num, by norm_num, by norm_num⟩
                  ·
