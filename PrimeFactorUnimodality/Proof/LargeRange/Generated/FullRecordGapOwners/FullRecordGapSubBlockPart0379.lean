...
theorem fullRecordGapSubBlock_part0379 (d : Nat) (193537 ≤ d) (d ≤ 194048) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨194040, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨193948, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨193924, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨193918, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨193822, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨193702, by norm_num, by norm_num, by norm_num⟩
                  ·
