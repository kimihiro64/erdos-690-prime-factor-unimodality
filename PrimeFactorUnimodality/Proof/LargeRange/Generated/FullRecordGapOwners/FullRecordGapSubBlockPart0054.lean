...
theorem fullRecordGapSubBlock_part0054 (d : Nat) (27137 ≤ d) (d ≤ 27648) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 27393 ≤ d
  ·
    by_cases h : 27521 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 840139) (by norm_num)
      right
      exact ⟨27648, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
