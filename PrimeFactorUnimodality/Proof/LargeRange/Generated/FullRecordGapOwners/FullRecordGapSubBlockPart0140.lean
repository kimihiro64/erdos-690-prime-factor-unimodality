...
theorem fullRecordGapSubBlock_part0140 (d : Nat) (71169 ≤ d) (d ≤ 71680) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 71425 ≤ d
  ·
    by_cases h : 71553 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 539929703) (by norm_num)
      right
      exact ⟨71442, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03607_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 35591) (by norm_num)
      exact by decide
                  ·
