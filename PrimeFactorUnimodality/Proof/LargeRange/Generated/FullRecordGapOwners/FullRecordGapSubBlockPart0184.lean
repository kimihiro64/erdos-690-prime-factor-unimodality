...
theorem fullRecordGapSubBlock_part0184 (d : Nat) (93697 ≤ d) (d ≤ 94208) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨94174, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨94114, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨94080, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨93802, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨93754, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨93750, by norm_num, by norm_num, by norm_num⟩
                  ·
