...
theorem fullRecordGapSubBlock_part0094 (d : Nat) (47617 ≤ d) (d ≤ 48128) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 47873 ≤ d
  ·
    by_cases h : 48001 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03634_not_prime
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 59621) (by norm_num)
      right
      exact ⟨47628, by norm_num, by norm_num, by norm_num⟩
                  ·
