...
theorem fullRecordGapSubBlock_part0777 (d : Nat) (397313 ≤ d) (d ≤ 397824) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨105779, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨397564, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨397438, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨33347, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨113124, by norm_num, by norm_num, by norm_num⟩
                  ·
