...
theorem fullRecordGapSubBlock_part0093 (d : Nat) (47105 ≤ d) (d ≤ 47616) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 47361 ≤ d
  ·
    by_cases h : 47489 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 218117) (by norm_num)
      right
      exact ⟨47520, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03635_not_prime
                  ·
