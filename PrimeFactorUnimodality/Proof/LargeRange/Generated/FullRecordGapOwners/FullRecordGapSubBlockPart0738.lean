...
theorem fullRecordGapSubBlock_part0738 (d : Nat) (377345 ≤ d) (d ≤ 377856) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨54167, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨377782, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨46747, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨377662, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨2016, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨49851, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨44281, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨377404, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨377374, by norm_num, by norm_num, by norm_num⟩
                  ·
