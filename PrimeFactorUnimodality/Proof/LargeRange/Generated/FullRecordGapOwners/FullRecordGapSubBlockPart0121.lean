...
theorem fullRecordGapSubBlock_part0121 (d : Nat) (61441 ≤ d) (d ≤ 61952) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 61697 ≤ d
  ·
    by_cases h : 61825 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03619_not_prime
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 2588231) (by norm_num)
      right
      exact ⟨61600, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
