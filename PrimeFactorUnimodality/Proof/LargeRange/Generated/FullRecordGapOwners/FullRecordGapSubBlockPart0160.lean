...
theorem fullRecordGapSubBlock_part0160 (d : Nat) (81409 ≤ d) (d ≤ 81920) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 81665 ≤ d
  ·
    by_cases h : 81793 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03594_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 40739) (by norm_num)
      exact by decide
                  ·
