...
theorem fullRecordGapAddBlock_part1512 (d : Nat) (317441 ≤ d) (d ≤ 317952) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨3952, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨69539, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨167485505, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨281977, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨14885, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨24046, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨12256961, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨62512085, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨30034, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨63620, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨58415509, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨38876, by norm_num, by norm_num, by norm_num⟩
                  ·
