...
theorem fullRecordGapAddBlock_part1335 (d : Nat) (226817 ≤ d) (d ≤ 227328) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨1190631, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨31886, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨10572135, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨838730159, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
