...
theorem fullRecordGapSubBlock_part0023 (d : Nat) (11265 ≤ d) (d ≤ 11776) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 11521 ≤ d
  ·
    by_cases h : 11649 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03711_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 364289) (by norm_num)
      right
      exact ⟨11550, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 7013029) (by norm_num)
      right
      exact ⟨11520, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03712_not_prime
                  ·
