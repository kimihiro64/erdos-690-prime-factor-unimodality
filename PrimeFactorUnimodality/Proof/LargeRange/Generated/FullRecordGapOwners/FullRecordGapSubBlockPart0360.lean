...
theorem fullRecordGapSubBlock_part0360 (d : Nat) (183809 ≤ d) (d ≤ 184320) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨184222, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨184204, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨184102, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨184084, by norm_num, by norm_num, by norm_num⟩
                  ·
