...
theorem fullRecordGapSubBlock_part0297 (d : Nat) (151553 ≤ d) (d ≤ 152064) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 151809 ≤ d
  ·
    by_cases h : 151937 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03200_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 11914508563) (by norm_num)
      right
      exact ⟨151882, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03201_not_prime
                  ·
