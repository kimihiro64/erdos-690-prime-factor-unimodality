...
theorem fullRecordGapSubBlock_part0074 (d : Nat) (37377 ≤ d) (d ≤ 37888) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 37633 ≤ d
  ·
    by_cases h : 37761 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 4766557) (by norm_num)
      right
      exact ⟨37632, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03652_not_prime
                  ·
