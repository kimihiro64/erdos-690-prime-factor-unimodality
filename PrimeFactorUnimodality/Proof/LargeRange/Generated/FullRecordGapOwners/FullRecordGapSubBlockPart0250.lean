...
theorem fullRecordGapSubBlock_part0250 (d : Nat) (127489 ≤ d) (d ≤ 128000) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 127745 ≤ d
  ·
    by_cases h : 127873 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 31981) (by norm_num)
      exact by decide
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03333_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 794879) (by norm_num)
      right
      exact ⟨127678, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 26867360827) (by norm_num)
      right
      exact ⟨127522, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
