...
theorem fullRecordGapAddBlock_part1457 (d : Nat) (289281 ≤ d) (d ≤ 289792) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨52599206643, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨1055759529, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨2256873485, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨41047245, by norm_num, by norm_num, by norm_num⟩
                  ·
