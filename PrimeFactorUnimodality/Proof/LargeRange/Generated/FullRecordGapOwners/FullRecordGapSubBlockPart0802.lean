...
theorem fullRecordGapSubBlock_part0802 (d : Nat) (410113 ≤ d) (d ≤ 410624) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨410622, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨50163, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨410422, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨410374, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨410188, by norm_num, by norm_num, by norm_num⟩
                  ·
