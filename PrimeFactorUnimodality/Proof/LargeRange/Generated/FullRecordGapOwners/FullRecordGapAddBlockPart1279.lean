...
theorem fullRecordGapAddBlock_part1279 (d : Nat) (198145 ≤ d) (d ≤ 198656) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨642571, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨1559426205, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨24963, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨56720675, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨364758839, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3614991, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
