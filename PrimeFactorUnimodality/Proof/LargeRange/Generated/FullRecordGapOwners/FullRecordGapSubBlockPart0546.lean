...
theorem fullRecordGapSubBlock_part0546 (d : Nat) (279041 ≤ d) (d ≤ 279552) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨279510, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨279508, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨279442, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨279438, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨279394, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨2436, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨279138, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨279094, by norm_num, by norm_num, by norm_num⟩
                  ·
