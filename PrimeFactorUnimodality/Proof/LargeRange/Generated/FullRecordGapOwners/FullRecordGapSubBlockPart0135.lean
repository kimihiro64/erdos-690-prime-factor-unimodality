...
theorem fullRecordGapSubBlock_part0135 (d : Nat) (68609 ≤ d) (d ≤ 69120) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 68865 ≤ d
  ·
    by_cases h : 68993 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 44347343) (by norm_num)
      right
      exact ⟨69120, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 34511) (by norm_num)
      exact by decide
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03610_not_prime
                  ·
