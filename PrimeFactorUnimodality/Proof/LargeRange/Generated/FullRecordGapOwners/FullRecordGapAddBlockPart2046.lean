...
theorem fullRecordGapAddBlock_part2046 (d : Nat) (590849 ≤ d) (d ≤ 591360) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨27037154195, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨320865, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨2580350411, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨75482, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨14416253, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨5366328981, by norm_num, by norm_num, by norm_num⟩
                  ·
