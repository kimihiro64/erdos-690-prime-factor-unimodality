...
theorem fullRecordGapAddBlock_part1733 (d : Nat) (430593 ≤ d) (d ≤ 431104) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨26528, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨213229, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨256804, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨791645, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨4379475, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨175985, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨5484329, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨7769035355, by norm_num, by norm_num, by norm_num⟩
                  ·
