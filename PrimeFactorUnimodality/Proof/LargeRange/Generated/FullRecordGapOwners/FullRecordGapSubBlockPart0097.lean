...
theorem fullRecordGapSubBlock_part0097 (d : Nat) (49153 ≤ d) (d ≤ 49664) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 49409 ≤ d
  ·
    by_cases h : 49537 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 1733905889) (by norm_num)
      right
      exact ⟨49500, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03630_not_prime
                  ·
