...
theorem fullRecordGapAddBlock_part1615 (d : Nat) (370177 ≤ d) (d ≤ 370688) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨46952732381, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨67626, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨4638809, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨276315221, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨104090, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨78605, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨2054507, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨60724, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨56029, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨28149, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨296420, by norm_num, by norm_num, by norm_num⟩
                  ·
