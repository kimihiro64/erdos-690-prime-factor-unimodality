...
theorem fullRecordGapSubBlock_part0139 (d : Nat) (70657 ≤ d) (d ≤ 71168) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 70913 ≤ d
  ·
    by_cases h : 71041 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 8835062081) (by norm_num)
      right
      exact ⟨71148, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
