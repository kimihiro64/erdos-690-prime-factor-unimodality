...
theorem fullRecordGapSubBlock_part0806 (d : Nat) (412161 ≤ d) (d ≤ 412672) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨96061, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨140879, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨412500, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨412494, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨412422, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨412408, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨412348, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨412312, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨412278, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨23655, by norm_num, by norm_num, by norm_num⟩
                  ·
