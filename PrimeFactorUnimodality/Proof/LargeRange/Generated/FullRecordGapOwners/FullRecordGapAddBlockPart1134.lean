...
theorem fullRecordGapAddBlock_part1134 (d : Nat) (123905 ≤ d) (d ≤ 124416) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨6643935, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨117900, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨65334107691, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨21755637, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
