...
theorem fullRecordGapSubBlock_part0651 (d : Nat) (332801 ≤ d) (d ≤ 333312) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨333244, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨333174, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨333142, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨332932, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨332818, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨332812, by norm_num, by norm_num, by norm_num⟩
                  ·
