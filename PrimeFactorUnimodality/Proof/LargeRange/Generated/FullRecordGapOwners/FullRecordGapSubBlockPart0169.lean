...
theorem fullRecordGapSubBlock_part0169 (d : Nat) (86017 ≤ d) (d ≤ 86528) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 86273 ≤ d
  ·
    by_cases h : 86401 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03592_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 550631) (by norm_num)
      right
      exact ⟨86302, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 43049) (by norm_num)
      exact by decide
                  ·
