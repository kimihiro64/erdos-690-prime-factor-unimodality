...
theorem fullRecordGapSubBlock_part0224 (d : Nat) (114177 ≤ d) (d ≤ 114688) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨31109, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨114574, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨114538, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨114358, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨8505, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨114214, by norm_num, by norm_num, by norm_num⟩
                  ·
