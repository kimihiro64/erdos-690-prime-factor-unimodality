...
theorem fullRecordGapSubBlock_part0820 (d : Nat) (419329 ≤ d) (d ≤ 419840) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨419754, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨46516, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨19159, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨419638, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨74354, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨419404, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨77191, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨75445, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨419338, by norm_num, by norm_num, by norm_num⟩
                  ·
