...
theorem fullRecordGapSubBlock_part0210 (d : Nat) (107009 ≤ d) (d ≤ 107520) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨107520, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨107434, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨107398, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨107362, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨107182, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨107098, by norm_num, by norm_num, by norm_num⟩
                  ·
