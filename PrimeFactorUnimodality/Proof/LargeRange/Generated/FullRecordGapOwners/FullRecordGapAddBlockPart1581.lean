...
theorem fullRecordGapAddBlock_part1581 (d : Nat) (352769 ≤ d) (d ≤ 353280) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨759123, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨12904, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨738485, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨91870067, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨282612107, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨75975530885, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨1081423, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨647365397, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨12154976859, by norm_num, by norm_num, by norm_num⟩
                  ·
