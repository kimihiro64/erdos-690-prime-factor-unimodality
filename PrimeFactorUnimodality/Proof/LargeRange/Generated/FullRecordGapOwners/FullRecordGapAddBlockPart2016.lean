...
theorem fullRecordGapAddBlock_part2016 (d : Nat) (575489 ≤ d) (d ≤ 576000) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨313833, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨23346553777, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨73266, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨8922540725, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨59859, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
