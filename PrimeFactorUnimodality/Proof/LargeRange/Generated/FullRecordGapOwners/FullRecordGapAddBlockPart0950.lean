...
theorem fullRecordGapAddBlock_part0950 (d : Nat) (29697 ≤ d) (d ≤ 30208) : ¬(recordGapCenter + d).Prime := by
  by_cases h : 29953 ≤ d
  ·
    by_cases h : 30081 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_add_not_prime (q := 1531813)
      right
      exact ⟨1501813, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
