...
theorem fullRecordGapAddBlock_part1483 (d : Nat) (302593 ≤ d) (d ≤ 303104) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨722261, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨5027891, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨236481, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨160340, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨5671043, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨83704959, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
