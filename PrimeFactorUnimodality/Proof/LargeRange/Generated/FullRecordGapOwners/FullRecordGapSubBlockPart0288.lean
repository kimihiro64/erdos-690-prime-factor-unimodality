...
theorem fullRecordGapSubBlock_part0288 (d : Nat) (146945 ≤ d) (d ≤ 147456) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨147454, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨147418, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨147178, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨147142, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨147058, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨147034, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨147000, by norm_num, by norm_num, by norm_num⟩
                  ·
