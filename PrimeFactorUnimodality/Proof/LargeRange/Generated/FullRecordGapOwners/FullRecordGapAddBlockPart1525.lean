...
theorem fullRecordGapAddBlock_part1525 (d : Nat) (324097 ≤ d) (d ≤ 324608) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨40758891545, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨21124005, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨375305, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
