...
theorem fullRecordGapSubBlock_part0559 (d : Nat) (285697 ≤ d) (d ≤ 286208) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨286194, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨286012, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨38910, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨285834, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨285814, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨285774, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨285772, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨285768, by norm_num, by norm_num, by norm_num⟩
                  ·
