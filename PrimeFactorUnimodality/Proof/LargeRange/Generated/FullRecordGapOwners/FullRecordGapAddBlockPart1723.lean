...
theorem fullRecordGapAddBlock_part1723 (d : Nat) (425473 ≤ d) (d ≤ 425984) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨7130958481, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨14480058865, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨6852369, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨101900, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨8858848377, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨145454, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨158972, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨6425, by norm_num, by norm_num, by norm_num⟩
                  ·
