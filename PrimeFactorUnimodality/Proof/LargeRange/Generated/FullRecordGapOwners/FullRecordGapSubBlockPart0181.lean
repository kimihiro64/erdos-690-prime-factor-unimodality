...
theorem fullRecordGapSubBlock_part0181 (d : Nat) (92161 ≤ d) (d ≤ 92672) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨92610, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨92542, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨92458, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨92400, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨92362, by norm_num, by norm_num, by norm_num⟩
                  ·
