...
theorem fullRecordGapSubBlock_part0079 (d : Nat) (39937 ≤ d) (d ≤ 40448) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 40193 ≤ d
  ·
    by_cases h : 40321 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 1778813) (by norm_num)
      right
      exact ⟨40320, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
