...
theorem fullRecordGapSubBlock_part0215 (d : Nat) (109569 ≤ d) (d ≤ 110080) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨110002, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨109918, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨39393, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨109834, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨109738, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨109702, by norm_num, by norm_num, by norm_num⟩
                  ·
