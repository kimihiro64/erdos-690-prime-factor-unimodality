...
theorem fullRecordGapSubBlock_part0089 (d : Nat) (45057 ≤ d) (d ≤ 45568) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 45313 ≤ d
  ·
    by_cases h : 45441 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 24230191) (by norm_num)
      right
      exact ⟨45360, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
