...
theorem fullRecordGapSubBlock_part0693 (d : Nat) (354305 ≤ d) (d ≤ 354816) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨354738, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨354714, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨139377, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨354678, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨354514, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨354498, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨354462, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨354414, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨97025, by norm_num, by norm_num, by norm_num⟩
                  ·
