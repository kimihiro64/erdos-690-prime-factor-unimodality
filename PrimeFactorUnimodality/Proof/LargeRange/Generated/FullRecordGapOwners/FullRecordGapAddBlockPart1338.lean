...
theorem fullRecordGapAddBlock_part1338 (d : Nat) (228353 ≤ d) (d ≤ 228864) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨3892691, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨5434907, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨169286, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨28080423, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
