...
theorem fullRecordGapSubBlock_part0078 (d : Nat) (39425 ≤ d) (d ≤ 39936) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 39681 ≤ d
  ·
    by_cases h : 39809 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03647_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03648_not_prime
                  ·
