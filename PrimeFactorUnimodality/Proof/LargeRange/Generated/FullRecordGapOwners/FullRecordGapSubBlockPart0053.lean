...
theorem fullRecordGapSubBlock_part0053 (d : Nat) (26625 ≤ d) (d ≤ 27136) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 26881 ≤ d
  ·
    by_cases h : 27009 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 69472223) (by norm_num)
      right
      exact ⟨26950, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03676_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03677_not_prime
                  ·
