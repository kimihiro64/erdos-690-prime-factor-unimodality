...
theorem fullRecordGapSubBlock_part0120 (d : Nat) (60929 ≤ d) (d ≤ 61440) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 61185 ≤ d
  ·
    by_cases h : 61313 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 10050069511) (by norm_num)
      right
      exact ⟨60984, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
