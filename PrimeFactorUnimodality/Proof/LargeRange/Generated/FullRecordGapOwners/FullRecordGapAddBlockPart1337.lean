...
theorem fullRecordGapAddBlock_part1337 (d : Nat) (227841 ≤ d) (d ≤ 228352) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨44605, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨14994009929, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨134825517, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨174981, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
