...
theorem fullRecordGapAddBlock_part1322 (d : Nat) (220161 ≤ d) (d ≤ 220672) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨3369233, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨161814533, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨96171, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨19467195, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨26803011, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨17254756341, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨163671, by norm_num, by norm_num, by norm_num⟩
                  ·
