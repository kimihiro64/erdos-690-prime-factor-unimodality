...
theorem fullRecordGapAddBlock_part1474 (d : Nat) (297985 ≤ d) (d ≤ 298496) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨1121596861, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨573509, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨363412801, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨1019567, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨3246882709, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3688275, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨379347153, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨173135, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨1628647631, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨912555, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨89161, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨88203759187, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨22818, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨2730151715, by norm_num, by norm_num, by norm_num⟩
                  ·
