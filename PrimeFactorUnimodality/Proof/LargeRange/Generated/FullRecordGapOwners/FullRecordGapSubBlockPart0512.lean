...
theorem fullRecordGapSubBlock_part0512 (d : Nat) (261633 ≤ d) (d ≤ 262144) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨261988, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨261894, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨261718, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨261678, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨72732, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨261652, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨261642, by norm_num, by norm_num, by norm_num⟩
                  ·
