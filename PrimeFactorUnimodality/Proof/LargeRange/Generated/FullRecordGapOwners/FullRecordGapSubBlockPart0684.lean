...
theorem fullRecordGapSubBlock_part0684 (d : Nat) (349697 ≤ d) (d ≤ 350208) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨350202, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨350188, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨350164, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨350158, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨350122, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨29888, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨349920, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨349878, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨349858, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨349768, by norm_num, by norm_num, by norm_num⟩
                  ·
