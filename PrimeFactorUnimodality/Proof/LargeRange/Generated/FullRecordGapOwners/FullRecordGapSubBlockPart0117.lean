...
theorem fullRecordGapSubBlock_part0117 (d : Nat) (59393 ≤ d) (d ≤ 59904) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 59649 ≤ d
  ·
    by_cases h : 59777 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 46439) (by norm_num)
      right
      exact ⟨12961, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
