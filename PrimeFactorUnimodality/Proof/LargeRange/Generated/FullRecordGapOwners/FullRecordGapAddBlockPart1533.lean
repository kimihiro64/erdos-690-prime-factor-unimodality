...
theorem fullRecordGapAddBlock_part1533 (d : Nat) (328193 ≤ d) (d ≤ 328704) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨6483, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨10916851343, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3987167, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨27442, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨10078799, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨337515, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨16072, by norm_num, by norm_num, by norm_num⟩
                  ·
