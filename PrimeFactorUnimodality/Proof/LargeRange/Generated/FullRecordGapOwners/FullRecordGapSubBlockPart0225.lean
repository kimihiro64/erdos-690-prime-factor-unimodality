...
theorem fullRecordGapSubBlock_part0225 (d : Nat) (114689 ≤ d) (d ≤ 115200) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 114945 ≤ d
  ·
    by_cases h : 115073 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03403_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03404_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03405_not_prime
                  ·
