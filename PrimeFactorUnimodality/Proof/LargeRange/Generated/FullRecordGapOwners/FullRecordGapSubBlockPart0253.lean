...
theorem fullRecordGapSubBlock_part0253 (d : Nat) (129025 ≤ d) (d ≤ 129536) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 129281 ≤ d
  ·
    by_cases h : 129409 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03322_not_prime
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03323_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 1758391) (by norm_num)
      right
      exact ⟨129358, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 23399755891) (by norm_num)
      right
      exact ⟨129334, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03324_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03325_not_prime
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 104207) (by norm_num)
      right
      exact ⟨24947, by norm_num, by norm_num, by norm_num⟩
                  ·
