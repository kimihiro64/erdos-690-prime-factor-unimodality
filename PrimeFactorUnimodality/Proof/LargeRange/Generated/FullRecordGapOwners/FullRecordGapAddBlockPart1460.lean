...
theorem fullRecordGapAddBlock_part1460 (d : Nat) (290817 ≤ d) (d ≤ 291328) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨66020, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨94127449, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨193275661, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨3698745, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨39601, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨472669877, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨2947181, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨22992, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨59617, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨2102191, by norm_num, by norm_num, by norm_num⟩
                  ·
