...
theorem fullRecordGapAddBlock_part1978 (d : Nat) (556033 ≤ d) (d ≤ 556544) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨197708, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨8221827, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨119044643, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨81671, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨90524387, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3740735, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨59285351, by norm_num, by norm_num, by norm_num⟩
                  ·
