...
theorem fullRecordGapSubBlock_part0815 (d : Nat) (416769 ≤ d) (d ≤ 417280) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨417262, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨110649, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨417154, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨25347, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨416982, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨416968, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨416958, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨416938, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨416932, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨416782, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨416778, by norm_num, by norm_num, by norm_num⟩
                  ·
