...
theorem fullRecordGapSubBlock_part0108 (d : Nat) (54785 ≤ d) (d ≤ 55296) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 55041 ≤ d
  ·
    by_cases h : 55169 ≤ d
    ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 2265080371) (by norm_num)
      right
      exact ⟨54880, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
