...
theorem fullRecordGapSubBlock_part0141 (d : Nat) (71681 ≤ d) (d ≤ 72192) : ¬(recordGapCenter - d).Prime := by
  by_cases h : 71937 ≤ d
  ·
    by_cases h : 72065 ≤ d
    ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03605_not_prime
                  ·
              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    subst d
      apply fullRecordGap_sub_not_prime (q := 7806698869) (by norm_num)
      right
      exact ⟨72000, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      exact ⟨1, by norm_num, by norm_num, by norm_num, by norm_num⟩
                ·
                  ...
                  ·
                    ...
                    subst d
      exact fullRecordGapTerm03606_not_prime
                  ·
