...
theorem fullRecordGapSubBlock_part0322 (d : Nat) (164353 ≤ d) (d ≤ 164864) : ¬(recordGapCenter - d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨164842, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨34880, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨164640, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨164614, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨164602, by norm_num, by norm_num, by norm_num⟩
                  ·
