...
theorem fullRecordGapAddBlock_part1154 (d : Nat) (134145 ≤ d) (d ≤ 134656) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨203669459, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨108258, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨3834146385, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨283421, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨264135, by norm_num, by norm_num, by norm_num, by norm_num⟩
                  ·
