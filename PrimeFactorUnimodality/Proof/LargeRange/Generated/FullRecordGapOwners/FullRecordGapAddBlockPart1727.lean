...
theorem fullRecordGapAddBlock_part1727 (d : Nat) (427521 ≤ d) (d ≤ 428032) : ¬(recordGapCenter + d).Prime := by
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨7844162963, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨70734491, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨474885, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨1720057077, by norm_num, by norm_num, by norm_num⟩
                  ·
  ...
  ·
    ...
    ·
      ...
      right
      exact ⟨16875, by norm_num, by norm_num, by norm_num⟩
                  ·
    ...
    ·
      ...
      right
      exact ⟨16196329761, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨105707965, by norm_num, by norm_num, by norm_num⟩
                  ·
      ...
      right
      exact ⟨2084489987, by norm_num, by norm_num, by norm_num⟩
                  ·
