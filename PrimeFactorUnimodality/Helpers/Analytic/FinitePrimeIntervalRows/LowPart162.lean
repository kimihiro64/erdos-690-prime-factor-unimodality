...
theorem lowPrime_14153 : Nat.Prime 14153 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((3 : ZMod 14153) ^ 7076 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((3 : ZMod 14153) ^ 7076 - 1)
      ...
      apply IsUnit.of_mul_eq_one (7076 : ZMod 14153)
      decide
    · change IsUnit ((3 : ZMod 14153) ^ 488 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (2649 : ZMod 14153)
      decide
    · change IsUnit ((3 : ZMod 14153) ^ 232 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14159 : Nat.Prime 14159 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((13 : ZMod 14159) ^ 7079 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (7079 : ZMod 14159)
      decide
    · change IsUnit ((13 : ZMod 14159) ^ 2 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14173 : Nat.Prime 14173 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((2 : ZMod 14173) ^ 7086 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((2 : ZMod 14173) ^ 7086 - 1)
      ...
      apply IsUnit.of_mul_eq_one (7086 : ZMod 14173)
      decide
    · change IsUnit ((2 : ZMod 14173) ^ 4724 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (8277 : ZMod 14173)
      decide
    · change IsUnit ((2 : ZMod 14173) ^ 12 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14177 : Nat.Prime 14177 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((3 : ZMod 14177) ^ 7088 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((3 : ZMod 14177) ^ 7088 - 1)
      ...
      apply IsUnit.of_mul_eq_one (7088 : ZMod 14177)
      decide
    · change IsUnit ((3 : ZMod 14177) ^ 32 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14197 : Nat.Prime 14197 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl | rfl | rfl | rfl | rfl
    · change IsUnit ((11 : ZMod 14197) ^ 7098 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((11 : ZMod 14197) ^ 7098 - 1)
      ...
      apply IsUnit.of_mul_eq_one (7098 : ZMod 14197)
      decide
    · change IsUnit ((11 : ZMod 14197) ^ 4732 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (3024 : ZMod 14197)
      decide
    · change IsUnit ((11 : ZMod 14197) ^ 2028 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (9977 : ZMod 14197)
      decide
    · change IsUnit ((11 : ZMod 14197) ^ 1092 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14207 : Nat.Prime 14207 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl
    · change IsUnit ((5 : ZMod 14207) ^ 7103 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (7103 : ZMod 14207)
      decide
    · change IsUnit ((5 : ZMod 14207) ^ 2 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14221 : Nat.Prime 14221 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl | rfl | rfl | rfl | rfl
    · change IsUnit ((2 : ZMod 14221) ^ 7110 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((2 : ZMod 14221) ^ 7110 - 1)
      ...
      apply IsUnit.of_mul_eq_one (7110 : ZMod 14221)
      decide
    · change IsUnit ((2 : ZMod 14221) ^ 4740 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((2 : ZMod 14221) ^ 4740 - 1)
      ...
      apply IsUnit.of_mul_eq_one (6355 : ZMod 14221)
      decide
    · change IsUnit ((2 : ZMod 14221) ^ 2844 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (7151 : ZMod 14221)
      decide
    · change IsUnit ((2 : ZMod 14221) ^ 180 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_14243 : Nat.Prime 14243 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl
    · change IsUnit ((2 : ZMod 14243) ^ 7121 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (7121 : ZMod 14243)
      decide
    · change IsUnit ((2 : ZMod 14243) ^ 2 - 1)
      rw [← natCast_fastPowMod_eq_pow]
