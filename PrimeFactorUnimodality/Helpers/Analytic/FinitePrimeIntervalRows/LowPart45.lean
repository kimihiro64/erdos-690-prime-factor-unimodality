...
theorem lowPrime_6079 : Nat.Prime 6079 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((17 : ZMod 6079) ^ 3039 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (3039 : ZMod 6079)
      decide
    · change IsUnit ((17 : ZMod 6079) ^ 2026 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (1508 : ZMod 6079)
      decide
    · change IsUnit ((17 : ZMod 6079) ^ 6 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_6089 : Nat.Prime 6089 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((3 : ZMod 6089) ^ 3044 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_6101 : Nat.Prime 6101 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl | rfl | rfl | rfl
    · change IsUnit ((2 : ZMod 6101) ^ 3050 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((2 : ZMod 6101) ^ 3050 - 1)
      ...
      apply IsUnit.of_mul_eq_one (3050 : ZMod 6101)
      decide
    · change IsUnit ((2 : ZMod 6101) ^ 1220 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((2 : ZMod 6101) ^ 1220 - 1)
      ...
      apply IsUnit.of_mul_eq_one (3503 : ZMod 6101)
      decide
    · change IsUnit ((2 : ZMod 6101) ^ 100 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_6113 : Nat.Prime 6113 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((3 : ZMod 6113) ^ 3056 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((3 : ZMod 6113) ^ 3056 - 1)
      ...
      apply IsUnit.of_mul_eq_one (3056 : ZMod 6113)
      decide
    · change IsUnit ((3 : ZMod 6113) ^ 32 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_6121 : Nat.Prime 6121 := by
  ...
  · intro q hq
    ...
    · change IsUnit ((7 : ZMod 6121) ^ 3060 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((7 : ZMod 6121) ^ 3060 - 1)
      ...
      apply IsUnit.of_mul_eq_one (3060 : ZMod 6121)
      decide
    · change IsUnit ((7 : ZMod 6121) ^ 2040 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((7 : ZMod 6121) ^ 2040 - 1)
      ...
      apply IsUnit.of_mul_eq_one (2424 : ZMod 6121)
      decide
    · change IsUnit ((7 : ZMod 6121) ^ 1224 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (4649 : ZMod 6121)
      decide
    · change IsUnit ((7 : ZMod 6121) ^ 360 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_6131 : Nat.Prime 6131 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl | rfl
    · change IsUnit ((2 : ZMod 6131) ^ 3065 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (3065 : ZMod 6131)
      decide
    · change IsUnit ((2 : ZMod 6131) ^ 1226 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (4906 : ZMod 6131)
      decide
    · change IsUnit ((2 : ZMod 6131) ^ 10 - 1)
      rw [← natCast_fastPowMod_eq_pow]
...
theorem lowPrime_6133 : Nat.Prime 6133 := by
  ...
  · intro q hq
    simp at hq
    rcases hq with rfl | rfl | rfl | rfl | rfl
    · change IsUnit ((5 : ZMod 6133) ^ 3066 - 1)
      rw [← natCast_fastPowMod_eq_pow]
    ...
    · change IsUnit ((5 : ZMod 6133) ^ 3066 - 1)
      ...
      apply IsUnit.of_mul_eq_one (3066 : ZMod 6133)
      decide
    · change IsUnit ((5 : ZMod 6133) ^ 2044 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (316 : ZMod 6133)
      decide
    · change IsUnit ((5 : ZMod 6133) ^ 876 - 1)
      rw [← natCast_fastPowMod_eq_pow]
      apply IsUnit.of_mul_eq_one (443 : ZMod 6133)
      decide
    · change IsUnit ((5 : ZMod 6133) ^ 84 - 1)
      rw [← natCast_fastPowMod_eq_pow]
