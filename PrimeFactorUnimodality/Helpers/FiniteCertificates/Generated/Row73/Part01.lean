...
/-! Generated segment 1 of the bounded selection row for endpoint 73. -/
...
theorem numericalRow73_2 :
    selectionRowBounded 6 primePrefix2 =
      [1, 0, 0, 0, 0, 0, 0] := by
  rfl

set_option linter.style.longLine false in
theorem numericalRow73_3 :
    selectionRowBounded 6 primePrefix3 =
      [1, 1, 0, 0, 0, 0, 0] := by
  rw [primePrefix3, selectionRowBounded, numericalRow73_2]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_5 :
    selectionRowBounded 6 primePrefix5 =
      [2, 3, 1, 0, 0, 0, 0] := by
  rw [primePrefix5, selectionRowBounded, numericalRow73_3]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_7 :
    selectionRowBounded 6 primePrefix7 =
      [8, 14, 7, 1, 0, 0, 0] := by
  rw [primePrefix7, selectionRowBounded, numericalRow73_5]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_11 :
    selectionRowBounded 6 primePrefix11 =
      [48, 92, 56, 13, 1, 0, 0] := by
  rw [primePrefix11, selectionRowBounded, numericalRow73_7]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_13 :
    selectionRowBounded 6 primePrefix13 =
      [480, 968, 652, 186, 23, 1, 0] := by
  rw [primePrefix13, selectionRowBounded, numericalRow73_11]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_17 :
    selectionRowBounded 6 primePrefix17 =
      [5760, 12096, 8792, 2884, 462, 35, 1] := by
  rw [primePrefix17, selectionRowBounded, numericalRow73_13]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_19 :
    selectionRowBounded 6 primePrefix19 =
      [92160, 199296, 152768, 54936, 10276, 1022, 51] := by
  rw [primePrefix19, selectionRowBounded, numericalRow73_17]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_23 :
    selectionRowBounded 6 primePrefix23 =
      [1658880, 3679488, 2949120, 1141616, 239904, 28672, 1940] := by
  rw [primePrefix23, selectionRowBounded, numericalRow73_19]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_29 :
    selectionRowBounded 6 primePrefix29 =
      [36495360, 82607616, 68560128, 28064672, 6419504, 870688, 71352] := by
  rw [primePrefix29, selectionRowBounded, numericalRow73_23]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_31 :
    selectionRowBounded 6 primePrefix31 =
      [1021870080, 2349508608, 2002291200, 854370944, 207810784, 30798768, 2868544] := by
  rw [primePrefix31, selectionRowBounded, numericalRow73_29]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_37 :
    selectionRowBounded 6 primePrefix37 =
      [30656102400, 71507128320, 62418244608, 27633419520, 7088694464, 1131773824, 116855088] := by
  rw [primePrefix37, selectionRowBounded, numericalRow73_31]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_41 :
  ...
  rw [primePrefix41, selectionRowBounded, numericalRow73_37]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_43 :
  ...
  rw [primePrefix43, selectionRowBounded, numericalRow73_41]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_47 :
  ...
  rw [primePrefix47, selectionRowBounded, numericalRow73_43]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_53 :
  ...
  rw [primePrefix53, selectionRowBounded, numericalRow73_47]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_59 :
  ...
  rw [primePrefix59, selectionRowBounded, numericalRow73_53]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_61 :
  ...
  rw [primePrefix61, selectionRowBounded, numericalRow73_59]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_67 :
  ...
  rw [primePrefix67, selectionRowBounded, numericalRow73_61]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_71 :
  ...
  rw [primePrefix71, selectionRowBounded, numericalRow73_67]
  norm_num [selectionRowStep, selectionRowTail]

set_option linter.style.longLine false in
theorem numericalRow73_73 :
  ...
  rw [primePrefix73, selectionRowBounded, numericalRow73_71]
  norm_num [selectionRowStep, selectionRowTail]
